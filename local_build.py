...
def generate_app_html(slides, out_path=None):
    ...
    full_html = (
        ...
        '<meta property="og:image" content="https://vibra-reboot.github.io/ogp-default.png">'
        '<meta property="og:url" content="https://vibra-reboot.github.io/">'
        ...
        'var st=localStorage.getItem("vibra_bt");'
        'if(st && st !== bt){'
        'location.reload(true);'
        'return;'
        '}'
        'localStorage.setItem("vibra_bt", bt);'
        'setInterval(function(){'
        'fetch(location.href,{cache:"no-store",method:"HEAD"})'
        '.then(function(r){'
        'var lm=r.headers.get("last-modified");'
        'if(lm && lm.indexOf(bt.split(" ")[0])===-1){'
        'location.reload(true);'
        '}'
        '}).catch(function(){});'
        '},60000);'
